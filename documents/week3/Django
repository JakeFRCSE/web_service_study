이전 posting에서 django 개발환경 세팅을 했으니 이제 <a href="https://docs.djangoproject.com/en/5.1/intro/tutorial01/">django tutorial</a>를 따라해 보면서 기본적인 django의 흐름에 대해서 알아보자. 
